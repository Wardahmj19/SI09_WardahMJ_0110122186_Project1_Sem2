                   ...
                   <div class="row">
                        <div class="col-sm-6 col-xs-12">
                              <div class="form-group">
                                   ...
                                   <input type="number" id="min_stok" name="min_stok" class="form-control" required>
                              </div>
                        </div>
                        <div class="col-sm-6 col-xs-12">
                              <div class="form-group">
                   ...
                   <div class="row">
                         <div class="col-sm-6 col-xs-12">
                              <div class="form-group">
                                   ...
                                   <select id="kategori_produk_id" name="kategori_produk_id" class="form-control" required>
